...
@section('content')
    <div class="content bg-white">
            ...
            <!-- Table Start -->
                    <div class="col-12 bg-white px-4 py-0" >
                        <h6 class="mb-4" style="margin:30px 10px;">이벤트관리</h6>
                        ...
                        <div class="bg-white rounded h-100 p-4">
                            ...
                            <table class="table table-bordered" style="font-size: 12px;">
                                ...
                                <tbody id="data_table">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="8" align="center">조회된 이벤트가 없습니다.</td>
                                        </tr>
                                    @endforelse   
    ...
    <script>
        ...
        const save = function(){
            ...
            $url = '/save_event?id='+id+'&title='+title+'&content='+content;
