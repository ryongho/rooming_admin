...
@section('content')
    <div class="content bg-white">
            ...
            <!-- Table Start -->
                    <div class="col-12 bg-white px-4 py-0" >
                        <h6 class="mb-4" style="margin:30px 10px;">객실 목록</h6>
                    </div>
                    <div class="col-12 bg-white px-4 py-0" style="float:left;">
                        <select class="form-select search_type mb-1" id="search_type" aria-label=".search_type" style="width:auto;float:left;margin-right:10px;">
                            ...
                            <option value="name">객실 이름</option>
                        ...
                        <div class="bg-white rounded h-100 p-4">
                            ...
                            <table class="table table-bordered" style="font-size: 12px;">
                                ...
                                <tbody id="data_table">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="8" align="center">조회된 객실이 없습니다.</td>
                                        </tr>
                                    @endforelse   
    ...
    <script>
        ...
        const get_list = function(page_no){
            ...
            $url = '/room_list?page_no='+page_no+'&start_date='+start_date+'&end_date='+end_date+'&search_type='+search_type+'&search_keyword='+search_keyword;
